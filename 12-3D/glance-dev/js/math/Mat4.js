...
export class Mat4 {
    ...
    static fromTranslation = Mat4.translate; // Deprecated
    ...
    static fromRotation = Mat4.rotate; // Deprecated
    ...
    static fromRotationX = Mat4.rotateX; // Deprecated
    ...
    static fromRotationY = Mat4.rotateY; // Deprecated
    ...
    static fromRotationZ = Mat4.rotateZ; // Deprecated
    ...
    static fromScale = Mat4.scale; // Deprecated
