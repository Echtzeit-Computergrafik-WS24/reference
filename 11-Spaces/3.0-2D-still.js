...
const vertexShaderSource = `#version 300 es
    ...
    uniform mat3 u_projectionXform;
    ...
    void main() {
        gl_Position = vec4(u_projectionXform * u_viewXform * u_modelXform * vec3(a_pos, 1.0), 1.0);
...
function myRenderLoop()
{
    ...
    quad.uniform.u_viewXform = glance.Mat3.identity();
    quad.uniform.u_projectionXform = glance.Mat3.identity();

    quad.uniform.u_modelXform = glance.Mat3.identity();
    glance.draw(gl, quad);
}
