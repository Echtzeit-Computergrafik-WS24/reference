...
export class Mat3
{
    ...
    public static fromTranslation = Mat3.translate; // Deprecated
    ...
    public static fromTranslationX = Mat3.translateX; // Deprecated
    ...
    public static fromTranslationY = Mat3.translateY; // Deprecated
    ...
    public static fromRotation = Mat3.rotate; // Deprecated
    ...
    public static fromScale = Mat3.scale; // Deprecated
