...
const geoFSSource = `#version 300 es
    ...
    void main() {
        ...
        // lighting
        vec3 normal = normalize(f_tbnXform * (texNormal * (255./128.) - 1.0));
...
// Tangent Attribute
const manualTangents = Array(geoGeo.texCoords.length / 2).fill([1, 0, 0]).flat();
...
const geo = glance.createDrawCall(gl, "geo",
    glance.createVertexArrayObject(gl, "geo-vao",
        geoGeo.indices,
        {
            ...
            a_tangent: { data: manualTangents, height: 3 },
        },
        geoProgram,
    ),
    geoProgram,
